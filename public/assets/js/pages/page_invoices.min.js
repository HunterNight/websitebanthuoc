    ...
    init: function () {
        ...
        var i = function (i) {
            var e = i, n = $("#invoice_template"), t = n.html(), o = Handlebars.compile(t), c = (parseInt(e.attr("data-invoice-id")), {
                invoice_id: {
                    invoice_number: Math.floor(200 * Math.random() + 1) + "/2016",
        ...
        $(invoice_list_class).on("click", "a", function (e) {
            e.preventDefault(), e.stopPropagation(), altair_md.card_show_hide($invoice_card, void 0, i, $(this)), $(this).closest("li").siblings("li").removeClass("md-list-item-active").end().addClass("md-list-item-active"), setTimeout(function () {
                altair_uikit.reinitialize_grid_margin()
            }, 560)
        }).find("a").eq(2).click()
